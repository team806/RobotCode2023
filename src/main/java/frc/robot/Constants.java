...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = Math.toRadians(100); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = Math.toRadians(190); // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = Math.toRadians(60); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = Math.toRadians(15); // FIXME Measure and set back right steer offset
}
